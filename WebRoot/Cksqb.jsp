...
<table width="745" height="743" border="1" align="center">
    ...
    <tr>
        <td colspan="3" height="300"><textarea style="font-size:18px;width:745px; height:300px" name="reason" readOnly
    ...
    %>
    <tr>
        <td colspan="3" align="center" valign="middle"><input type="button" name="back" value="返回"
