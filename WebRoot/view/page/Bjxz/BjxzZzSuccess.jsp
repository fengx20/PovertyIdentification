<%@ page language="java" import="java.util.*,com.wzxy.povertyidentification.bean.Xs,java.util.List"
         pageEncoding="UTF-8" %>
<%
...
<div class="layout_top_header">
    ...
    <div id="ad_setting" class="ad_setting">
        <a class="ad_setting_a" href="javascript:; ">
            ...
            <span><%=request.getAttribute("fullstuNo") %>(组长)</span>
...
<%
    ...
    String BjzzstuNo = (String) request.getAttribute("fullstuNo");
    if (list.size() != 0) {
...
<div class="layout_left_menu">
    <ul id="menu">
        ...
        <li class="childUlLi">
            <a href="" target="menuFrame"> <i class="glyph-icon icon-reorder"></i>班级申请表</a>
            <ul>
                <li><a href="servlet/PkrdsqbServlet?action=<%=7 %>&className=<%=list.get(i).getClassName()%>"
                       target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查看投票情况</a></li>
            </ul>
        </li>
    </ul>
</div>
...
<div id="layout_right_content" class="layout_right_content">
    ...
    <div class="route_bg">
        ...
        <a href="servlet/PkrdsqbServlet?action=<%=7 %>&className=<%=list.get(i).getClassName()%>" target="menuFrame">查看申请表投票情况</a>
    </div>
