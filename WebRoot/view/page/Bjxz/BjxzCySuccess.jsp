...
<div class="layout_left_menu">
    <ul id="menu">
        ...
        <li class="childUlLi">
            ...
            <ul>
                <li>
                    <a href="servlet/PkrdsqbServlet?action=<%=4 %>&className=<%=list.get(i).getClassName()%>&bjcystuNo=<%=request.getAttribute("fullstuNo") %>"
                       target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>本班申请表</a></li>
            </ul>
        </li>
    </ul>
</div>
