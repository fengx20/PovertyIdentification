<%@ page language="java" import="java.util.*,com.wzxy.povertyidentification.bean.Toupiao,java.util.List"
         pageEncoding="UTF-8" %>
<%
...
<div style="width:100%;height:90%;overflow:auto">
    <table width="95%" border="1" align="center" cellpadding="3" cellspacing="3" style="align:center;">
        ...
        <tr style="font-weight:bold;" align="center">
            ...
            <td>
                <a href="servlet/PkrdsqbServlet?action=<%=5 %>&fullstuNo=<%=list.get(i).getXs()%>&bjcystuNo=<%=BjcystuNo%>">查看申请书并投票</a>
            </td>
        </tr>
        <%
            }
