    ...
    <table width="745" height="743" border="1" align="center">
        ...
        <tr>
            ...
            <td width="259" align="right" valign="middle">姓名:&nbsp;&nbsp;<input type="text" name="stuName" id="stuName"
                                                                                ...
                                                                                style="height25px;width:160px;font-size:15px"/>
            </td>
        ...
        <tr align="center" valign="middle">
            <td colspan="2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系电话:&nbsp;&nbsp;<input type="text"
                                                                                                 name="phoneNum"
                                                                                                 readOnly id="phoneNum"
        ...
        <tr>
            <td colspan="3" align="center" valign="middle">家庭人均收入:&nbsp;&nbsp;
                <input type="text" name="money" id="money" readOnly value="<%=list.get(i).getMoney()%>"
                       style="height:25px;width:220px;font-size:15px"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" height="300"><textarea style="width:745px; height:300px;font-size:20px" name="reason"
                                                   readOnly id="reason"><%=list.get(i).getReason()%></textarea></td>
        </tr>
        <%
                }
            }
        %>
        <tr>
            <td colspan="3" align="center" valign="middle"><input type="radio" name="toupiao" id="toupiao"
                                                                  value="tongguo"/>通过&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                    type="radio" name="toupiao" id="toupiao" value="fandui"/>反对
            </td>
        </tr>
        <tr>
            <td colspan="3" align="center" valign="middle"><input type="submit" name="toupiao_tj" value="提交"
                                                                  style="height:30px;width:50px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                    type="button" name="back" value="返回" style="height:30px;width:50px"
