...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="align:center;">
    <tr>
        ...
        <th width="74%" align="left" valign="bottom">
            <form name="chazhao" method="post" action="<%=path%>/servlet/PkrdsqbServlet">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="hidden" name="action" value="21"/>
                <input type="text" name="fullstuNo" id="fullstuNo" style="height:30px;width:200px"/>
                <input type="submit" name="chazhao_xssqb" style="height:30px;width:50px" value="查找"/>
            </form>
        </th>
    </tr>
</table>
<div style="width:100%;height:90%;overflow:auto">
    <table width="95%" border="1" align="center" cellpadding="3" cellspacing="3" style="align:center;">
        ...
        <%
            ...
            List<Pkrdsqb> list = (List) request.getAttribute("allsqb");
            if (list.size() != 0) {
