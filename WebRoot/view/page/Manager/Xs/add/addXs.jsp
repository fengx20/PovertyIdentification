...
<form name="addXs" method="post" id="form" onSubmit="return validate()" action="<%=path%>/servlet/XsServlet">
    ...
    <input type="hidden" name="level" id="level" value="xs"/>
    <input type="hidden" name="zhuangtai" id="zhuangtai" value="未提交"/>
    <table width="598" height="370" border="1" align="center">
        ...
        <tr>
            ...
            <td align="left"><input type="text" name="stuName" class="{required:true}" id="stuName"
        ...
        <tr>
            <td colspan="2" align="center"><input type="submit" name="addXs_tj" value="添加"
                                                  style="height:30px;width:50px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                    type="reset" name="reset" value="重置" style="height:30px;width:50px"/></td>
        </tr>
    </table>
</form>
</body>
