<%@ page language="java" import="java.util.*,java.util.List,com.wzxy.povertyidentification.bean.Xs;" pageEncoding="UTF-8"%>
<%
  ...
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="align:center;">
   ...
   <tr style="font-weight:bold;" align="center">
      ...
      <td><%=list.get(i).getGrade()%></td>
       ...
       <td width="56"><a href="servlet/XsServlet?action=<%=2 %>&stuNo=<%=list.get(i).getStuNo()%>" onclick="confirm('确认删除？');">删除</a>
      </td>
   </tr>
