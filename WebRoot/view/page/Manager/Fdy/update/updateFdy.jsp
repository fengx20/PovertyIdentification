  ...
  <body>
   ...
   <table width="60%" height="370" border="1" align="center">
      <tr>
       ...
       <input type="text" name="teacherNo" value="<%=teacherNo %>" title="教职工号不能改变" style="height:30px;width:250px"/>
        </td>
      </tr>
      <tr>
        <td align="right">姓名：</td>
        <td align="left"><input type="text" name="teacherName" id="teacherName" style="height:30px;width:250px"/></td>
      </tr>
      <tr>
      ...
      <tr>
      <td colspan="2" align="center"><input type="submit" name="updateFdy_tj" value="确定" style="height:30px;width:50px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="fanhui" value="返回" style="height:30px;width:50px" onclick="window.history.go(-1)"/></td>
      </tr> 
 </table>
  </form>
  </body>
