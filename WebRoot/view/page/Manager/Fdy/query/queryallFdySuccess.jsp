<%@ page language="java" import="java.util.*,java.util.List,com.wzxy.povertyidentification.bean.Fdy"
         pageEncoding="UTF-8" %>
<%
...
<div style="width:100%;height:90%;overflow:auto">
    <table width="95%" border="1" align="center" cellpadding="3" cellspacing="3" style="align:center;">
        ...
        <tr style="font-weight:bold;" align="center">
            <td height="41"><%=list.get(i).getTeacherNo() %>
            </td>
            <td><%=list.get(i).getTeacherName() %>
            </td>
            <td><%=list.get(i).getXueyuan()%>
            </td>
            <td><%=list.get(i).getPhoneNum()%>
            </td>
            <td width="113"><a href="servlet/FdyServlet?action=<%=5 %>&teacherNo=<%=list.get(i).getTeacherNo()%>">修改</a>
            </td>
            <td width="113"><a href="servlet/FdyServlet?action=<%=2 %>&teacherNo=<%=list.get(i).getTeacherNo()%>"
                               onclick="confirmdialog()">删除</a>
            </td>
        </tr>
        <%
            }
