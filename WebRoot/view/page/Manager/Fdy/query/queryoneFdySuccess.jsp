<%@ page language="java" import="java.util.*,com.wzxy.povertyidentification.bean.Fdy,java.util.List"
         pageEncoding="UTF-8" %>
<%
...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" style="align:center;">
    ...
    <tr style="font-weight:bold;" align="center">
        ...
        <td><a href="servlet/FdyServlet?action=<%=2 %>&teacherNo=<%=list.get(i).getTeacherNo()%>"
