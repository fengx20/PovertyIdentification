...
<html>
  ...
  <body>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="refresh" value="刷新" style="height:30px;width:50px" onclick="location.reload()"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="back" value="返回" style="height:30px;width:50px" onclick="window.history.go(-1)"/>
    <p>&nbsp;</p>
   ...
   <tr style="font-weight:bold;" align="center">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="servlet/PkrdsqbServlet?action=<%=11 %>&fullstuNo=<%=list.get(i).getFullstuNo()%>" onclick="return confirm('确定提交？')" >提交至系学院处</a>     
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="javascript:void(0)" onclick="window.open('view/page/Fdy/Fdytuihui.jsp?fullstuNo=<%=list.get(i).getFullstuNo()%>','_blank','width=800,height=380,top=250,left=350')" style="color:red">退回办结</a>
      </td>
   </tr>
  <%
      }
