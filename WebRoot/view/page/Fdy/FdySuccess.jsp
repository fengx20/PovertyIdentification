...
<div class="layout_top_header">
    ...
    <div id="ad_setting" class="ad_setting">
        ...
        <ul class="dropdown-menu-uu" style="display: none" id="ad_setting_ul">
            <li class="ad_setting_ul_li"><a href="ChangePwd.jsp?user_no=+<%=request.getAttribute("teacherNo") %>"
...
<div class="layout_left_menu">
    <ul id="menu">
        ...
        <li class="childUlLi">
            ...
            <ul>
                <li><a href="servlet/BjServlet?action=<%=1 %>&teacherNo=<%=request.getAttribute("teacherNo") %>"
