 ...
 <body>
    ...
    <div class="layout_top_header">
            ...
            <div id="ad_setting" class="ad_setting">
                <a class="ad_setting_a" href="javascript:; ">
                    ...
                    <span><%=request.getAttribute("teacherNo") %>(辅导员)</span>
                    <i class="icon-chevron-down glyph-icon"></i>
                </a>
                <ul class="dropdown-menu-uu" style="display: none" id="ad_setting_ul">
                <li class="ad_setting_ul_li"> <a href="ChangePwd.jsp?user_no=+<%=request.getAttribute("teacherNo") %>" target="menuFrame"><i class="icon-cog glyph-icon"></i>修改密码</a></li>
    ...
    <div class="layout_left_menu">
        <ul id="menu">
            ...
            <li class="childUlLi">
                ...
                <ul>
                    <li><a href="servlet/BjServlet?action=<%=1 %>&teacherNo=<%=request.getAttribute("teacherNo") %>" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查看申请表</a></li> 
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div id="layout_right_content" class="layout_right_content">
        ...
        <div class="route_bg">
            ...
            <a href="servlet/BjServlet?action=<%=1 %>&teacherNo=<%=request.getAttribute("teacherNo") %>" target="menuFrame">查看班级申请表</a>
        </div>
