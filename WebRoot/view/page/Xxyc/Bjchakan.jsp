...
<html>
  ...
  <body>
   ...
   <tr style="font-weight:bold;" align="center">
     ...
     <td>
      <a href="servlet/PkrdsqbServlet?action=<%=17 %>&fullstuNo=<%=list.get(i).getFullstuNo()%>" onclick="return confirm('确定提交？')" >提交至学工处</a>     
      </td>
      <td>
      <a href="javascript:void(0)" onclick="window.open('view/page/Xxyc/tuihui.jsp?fullstuNo=<%=list.get(i).getFullstuNo()%>','_blank','width=740,height=330,top=250,left=350')" style="color:red">退回辅导员岗</a>    
      </td>
   </tr>
  <%
      }
