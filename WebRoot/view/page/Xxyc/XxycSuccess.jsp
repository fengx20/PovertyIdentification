 ...
 <body>
    ...
    <div class="layout_top_header">
            ...
            <div id="ad_setting" class="ad_setting">
                ...
                <li class="ad_setting_ul_li"> <a href="ChangePwd.jsp?user_no=+<%=request.getAttribute("xxyc") %>" target="menuFrame"><i class="icon-cog glyph-icon"></i>修改密码</a></li>
    ...
    <div class="layout_left_menu">
        <ul id="menu">
            ...
            <li class="childUlLi">
                ...
                <ul>
                    <li><a href="servlet/BjServlet?action=<%=2 %>&teacherNo=<%=request.getAttribute("xxyc") %>" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查看申请表</a></li>   
                </ul>
            </li>
        </ul>
    </div>
