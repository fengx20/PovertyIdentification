...
<html>
  ...
  <table width="745" height="743" border="1" align="center">
    <tr>
      <td colspan="3" align="center" valign="middle">贫困认定申请表<input type="text" name="zhuangtai" id="zhuangtai" readOnly style="width:250px;color:red;text-align:center;height:25px;font-size:15px" value="<%=list.get(i).getZhuangtai()%>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="openjuti();" style="color:red">查看具体</a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" height="300" ><textarea style="font-size:20px;width:745px; height:300px" name="reason" readOnly id="reason" ><%=list.get(i).getReason()%></textarea></td>
    </tr>
    ...
    <tr>
      <td colspan="3" align="center" valign="middle"><input type="button" name="fanhui" value="返回" style="height:30px;width:50px" onclick="javascript:window.location.href='welcome.jsp'"/></td>
    </tr>
  </table>
  </body>
</html>
