...
<div class="layout_top_header">
    ...
    <div id="ad_setting" class="ad_setting">
        ...
        <ul class="dropdown-menu-uu" style="display: none" id="ad_setting_ul">
            <li class="ad_setting_ul_li"><a href="ChangePwd.jsp?user_no=+<%=request.getAttribute("xxgc") %>"
...
<div class="layout_left_menu">
    <ul id="menu">
        ...
        <li class="childUlLi">
            ...
            <ul>
                <li><a href="servlet/PkrdsqbServlet?action=<%=22 %>" target="menuFrame"><i
                        class="glyph-icon icon-chevron-right"></i>审核申请表</a></li>
                <li><a href="servlet/PkrdsqbServlet?action=<%=27 %>" target="menuFrame"><i
                        class="glyph-icon icon-chevron-right"></i>已通过审核申请表</a></li>
            </ul>
        </li>
    </ul>
</div>
...
<div id="layout_right_content" class="layout_right_content">
    ...
    <div class="route_bg">
        ...
        <a href="servlet/BjServlet?action=<%=2 %>&teacherNo=<%=request.getAttribute("xxyc") %>"
