    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (_key) {
            ...
            case 25: //学生填写申请表前判断(逻辑)
                ...
                if (DaoFactory.getXsDaoInstance().checkXstj(FullstuNo20) == true) {
            ...
            case 1: //学生填写申请表提交功能(学生用户)
                ...
                if (DaoFactory.getPkrdsqbDaoInstance().checkchongming(FullstuNo) == false) {     //判断pkrdsqbxx表有无此学号数据
            ...
            case 6: //小组成员投票传投票值到数据库　　　
                ...
                if (DaoFactory.getToupiaoDaoInstance().checkzt(BjcystuNo2, FullstuNo4) == true) {   //判断该小组成员是否已投票，没投就可以投， 投了的就不能投
